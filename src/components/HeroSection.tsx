  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 pt-20">
        <p className="text-gold-light text-sm md:text-base tracking-[0.3em] uppercase mb-4 font-light">
          Con la compañía de mis padres tengo el honor de invitarte a celebrar
        </p>
        <h2 className="font-serif-elegant text-primary text-3xl md:text-5xl font-semibold tracking-wider mb-2">
          MIS XV AÑOS
        </h2>
